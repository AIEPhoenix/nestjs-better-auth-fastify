...
describe('AppController (e2e) - Real better-auth', () => {
  ...
  describe('Public Routes', () => {
    ...
    it('GET /session-via-service - should return session info or not authenticated message', async () => {
      const response = await request(app.getHttpServer())
      ...
      // Without authentication, should return 'Not authenticated'
      expect(response.body.authenticated).toBe(false);
    });
  });

  describe('Better Auth Routes', () => {
    it('POST /api/auth/sign-up/email - should create a new user', async () => {
      ...
      // better-auth may return token instead of session
      expect(
    ...
    it('POST /api/auth/sign-in/email - should login user', async () => {
    ...
    it('GET /api/auth/get-session - should return current session', async () => {
      ...
      // better-auth session endpoint is /api/auth/get-session
      const response = await request(app.getHttpServer())
  ...
  describe('Protected Routes', () => {
    it('GET /profile - should return 401 without authentication', async () => {
    ...
    it('GET /me - should return 401 without authentication', async () => {
  ...
  describe('@UserProperty() Decorator', () => {
    it('GET /my-email - should return 401 without authentication', async () => {
      await request(app.getHttpServer()).get('/my-email').expect(401);
    });
  ...
  describe('AuthService Programmatic Usage', () => {
    ...
    it('GET /check-session-fresh - should return session freshness info', async () => {
      ...
      // Newly created session should be fresh
  ...
  describe('Additional AuthService Methods', () => {
    it('GET /check-permissions - should return 401 without auth', async () => {
      await request(app.getHttpServer()).get('/check-permissions').expect(401);
    });
    ...
    it('POST /revoke-session/:sessionId - should return 401 without auth', async () => {
      await request(app.getHttpServer())
    ...
    it('GET /check-ban-status - should return 401 without auth', async () => {
      await request(app.getHttpServer()).get('/check-ban-status').expect(401);
    });
    ...
    it('GET /active-organization - should return 401 without auth', async () => {
      await request(app.getHttpServer())
    ...
    it('GET /check-org-role - should return 401 without auth', async () => {
      await request(app.getHttpServer()).get('/check-org-role').expect(401);
    });
    ...
    it('GET /check-org-permission - should return 401 without auth', async () => {
      await request(app.getHttpServer())
